...
public class DefaulterList extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable() {
        ...
        // Create a LinkedList to store the data
        ...
        try {
            ...
            // Loop through the result set and add rows to the LinkedList
            while (rs.next()) {
                ...
                // Store the row as an Object array
                Object[] row = {id, bookName, studentName, issueDate, dueDate, status};
                rows.add(row);
            }
            ...
            // Add all rows from the LinkedList to the table model
            for (Object[] row : rows) {
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 40, 210, -1));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 850, 270));
